...
DISCLOSURE: the solver read handout/server.py at 11:20Z, BEFORE the joints were
split, so the probe is NOT source-blind. Treat agreement with the backend
session's reading as unsurprising; only DISAGREEMENTS are informative.
"""
