#!/usr/bin/env python3
"""
Vaultkeeper: the audit_search substring oracle. Not loopback gated, does not
need a capability.
...
key.rotate, and key.save, none of which touch the mask, so step 1 is one
request that decides whether the deployed build differs.
"""
import argparse
import base64
import itertools
